...
function respond() {
    var request = JSON.parse(this.req.chunks[0]), botRegex1 = /^\/cool guy$/, botRegex2 = /.*[Nn].[Gg][Gg].[Rr].*/, botRegex3 = /^\/8ball.*/, botRegex4 = /^\/patchnotes$/, botRegex7=/.*[Gg][Rr][Ee][Ee][Tt][Ii][Nn][Gg].*/;
    ...
    if (request.text && reg1) {
        ...
        switch (Math.floor(Math.random()*4)){
           ...
           break; 
           case 3:
           postMessage('Death calls us all,  and we continuue to ignore it\'s sweet beckon');
           break;
           default:

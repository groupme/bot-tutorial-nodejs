...
      botRegex = /^\/cool guy/;  botRegexDL = /^\/DDL/i;botRegexHarper = /^\/Harper/;botRegexFeeney =/^\/feeney/;
...
    this.res.end();
  } 
    else if(request.text && botRegexFeeney.test(request.text)) {
    this.res.writeHead(200);

postMessage("https://media1.giphy.com/media/RdsvvZXIzBgNq/giphy.gif");
    this.res.end();
  }  
